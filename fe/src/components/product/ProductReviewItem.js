  ...
  return (
    <div className="ProductReviewItem">
      <div className="ReviewImgArea">
        ...
        {isEdit ? (
          <div className="ReviwImgChangeBtn ReviewText" style={{ fontSize: 5 }}>
            <input
              type="file"
              onChange={(e) => {
      ...
      <div className="ReviewContentArea">
        <div className="ReviewNameArea">
          <h5 className="ReviewText" style={{ fontWeight: 500 }}>
            {id}. {userNickName}
          </h5>
          <h5 className="ReviewText" style={{ fontSize: 5 }}>
            {day}
          </h5>
        </div>
        <div className="ReviewContent">
          {isEdit ? (
            ...
            <>
              <div className="ReviewText" style={{ fontSize: 15 }}>
                {localContent.split("\n").map((line, index) => (
