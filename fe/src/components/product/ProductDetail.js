...
const ProductDetail = () => {
  ...
  const clickBuyBotton = () => {
    ...
    if (number == 0) {
      ...
      console.log(number);
      navigate(`/shop/product/buy/${item.productId}`, {
        state: { ...item, number },
      });
    }
  };
      ...
      <div className="page">
        <div className="flexwrab ">
          ...
          <div className="ContentArea">
            ...
            <div className="TotalPrices">
              <text
                className="Text"
                style={{ color: "#214C2D", marginRight: 10 }}
              >
                총 상품 금액
              </text>
              <text
                className="NameText"
                style={{ fontWeight: "700", color: "#214C2D" }}
              >
            ...
            {user.isLoggedIn ? (
              <div className="buyBottonArea">
                <div
                  className="buyBotton Text"
                  onClick={clickEditBotton}
        ...
        <div className="ProductContentDetailArea">
          <div>
            ...
            <h2 className="Text" onClick={openContentAreaHandler}>
              상품 상세설명 ▼
            </h2>
            {isOpenContent ? (
              <div>
          ...
          <div>
            <h2 className="Text" onClick={openReviewAreaHandler}>
              리뷰 ▼
            </h2>
            {isOpenReview ? (
              // <>
